...
## Resolving yeoman errors 
if you get the following error 

```
Waiting...<WARN> EMFILE, too many open files Use --force to continue. </WARN>

```

to fix this on mac you can issue the following command in Terminal that you are running ```yeoman server```
